 ...
 * CESTA: /ui-web/src/testing/modal-components/MiniNotificationModal/MiniNotificationModal.tsx
...
import './MiniNotificationModal.css';
...
const MiniNotificationModal: React.FC<MiniNotificationModalProps> = ({
  ...
  return (
    <div style={{
      ...
      padding: '20px',
      pointerEvents: 'none' // Let ModalTemplate overlay handle blocking
    }}>    {/* Fullscreen but transparent - don't block ModalTemplate dimming */}
